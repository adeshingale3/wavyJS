...
export { default as JavascriptCardIcon } from './JavascriptCardIcon';
export { default as JavaCardIcon } from './JavaCardIcon';
...
export {default as DartCardIcon} from './DartCardIcon'
