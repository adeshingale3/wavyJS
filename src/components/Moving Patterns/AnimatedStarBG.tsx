...
export interface AnimatedStarGridProps {
  /** Size of each star */
  starSize?: number
...
const AnimatedStarGrid: React.FC<AnimatedStarGridProps> = ({
  starSize = 18,
  spacing = 60,
  rotationSpeed = 1,
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      stars.current.forEach((star) => {
        ...
        drawStar(star.x, star.y, starSize, star.rotation, star.color)
      })
  ...
  }, [starSize, spacing, colors, rotationSpeed])
...
AnimatedStarGrid.displayName = "AnimatedStarGrid"
export default AnimatedStarGrid
